# Common variable declarations shared by ALL provider roots.
...
variable "location" {
  type        = string
  description = "Provider region/location (Hetzner: e.g. nbg1; OVH: e.g. GRA, WAW)."
}
...
variable "bastion_server_type" {
  type        = string
  description = "Provider server flavor (Hetzner: e.g. cx23; OVH: e.g. b2-7)."
}
