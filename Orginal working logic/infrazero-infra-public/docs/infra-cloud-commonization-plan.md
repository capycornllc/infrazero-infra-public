...
Status: read-only audit plan. No implementation is included here.
...
## Current high-level similarity

The current bootstrap code is heavily duplicated. Similarity below is based on line-level LCS comparison of paired Hetzner/OVH files.
