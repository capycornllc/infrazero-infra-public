...
# NAT: egress always provides MASQUERADE for the private subnet.
# Private-only nodes use this egress as their gateway for internet access.
...
for _infra_attempt in {1..5}; do
  ...
  sleep 15
  # Clean up partial containers before retry
