...
infrazero_require_env "INFISICAL_SITE_URL" "infisical-bootstrap"
infrazero_require_env "INFISICAL_RESTORE_FROM_S3" "infisical-bootstrap"
infrazero_require_env "S3_ACCESS_KEY_ID" "infisical-bootstrap"
infrazero_require_env "S3_SECRET_ACCESS_KEY" "infisical-bootstrap"
infrazero_require_env "S3_ENDPOINT" "infisical-bootstrap"
infrazero_require_env "S3_REGION" "infisical-bootstrap"
infrazero_require_env "DB_BACKUP_BUCKET" "infisical-bootstrap"
infrazero_require_env "INFISICAL_DB_BACKUP_AGE_PUBLIC_KEY" "infisical-bootstrap"
infrazero_require_env "INFISICAL_EMAIL" "infisical-bootstrap"
infrazero_require_env "INFISICAL_PASSWORD" "infisical-bootstrap"
infrazero_require_env "INFISICAL_ORGANIZATION" "infisical-bootstrap"
infrazero_require_env "INFISICAL_PROJECT_NAME" "infisical-bootstrap"
...
apt_get() {
  ...
  INFRAZERO_APT_CLEAN_LISTS="${INFRAZERO_APT_CLEAN_LISTS:-false}" \
    infrazero_apt_get "infisical-bootstrap" "$@"
}
...
if ! command -v aws >/dev/null 2>&1; then
  if declare -F infrazero_ensure_aws_cli >/dev/null 2>&1; then
    infrazero_ensure_aws_cli "infisical-bootstrap"
  else
    echo "[infisical-bootstrap] common-base.sh missing infrazero_ensure_aws_cli" >&2
  fi
fi
